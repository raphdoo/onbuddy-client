  ...
  return (
    <div className="h-screen bg-gray-200 sm:Relative">	
    	<section className="">
        	...
        	<div className="text-white flex justify-start items-center gap-2 font-bold">
            <Image src={user1} alt="User profile" className="h-5 w-5" />
            <h2 className="">Change password</h2>
        	</div>
    		</div>
    		<div className="sm:absolute top-52 sm:max-w-7xl mx-auto  bg-white rounded-2xl w-full sm:ml-36">
