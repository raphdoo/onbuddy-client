  ...
  return (
    <div>
			...
			<section  className="h-full w-full text-white flex flex-col justify-center" style={{ background:"url('src/assets/images/img-bg.png')", backgroundRepeat:"no-repeat", backgroundPosition:"center", backgroundSize:"cover" }}>
				<div className="max-w-7xl mx-auto sm:grid grid-cols-12 flex flex-col gap-32 mt-32 pb-20 w-full">
            ...
            label="Edit Profile"
					...
					<section className="col-span-7  space-y-6">
						<div className="sm:py-10 sm:px-0 px-10">
						...
						<div className="sm:px-0 px-10">
							...
							<div className="divide divide-y-2 bg-white p-10">
								...
								<div className="text-black flex justify-between">
									...
									<section className="hidden sm:block">
										<input type="date" className="outline-none border-none focus:outline-none focus:ring-0" placeholder="24/10/23" />
									</section>
								</div>
								<div className="text-black flex justify-between">
									<section className="">
