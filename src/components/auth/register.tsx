      ...
      <div className="text-black text-2xl grid md:grid-cols-2 items-center h-screen bg-background">
       <div className="h-full w-full relative hidden md:grid">
        ...
        <form className="p-6 grid items-center">
            ...
            <p className="text-center">Have an account ?  <a href="/login" className="text-primary font-semibold">Login</a></p>
          ...
          <button className={`delay-100 transition rounded-lg py-1 border text-white text-md bg-primary w-1/3 m-auto font-[0.9rem]`}>Register</button>
          <p className="text-center mt-2 font-semibold">or</p>
          <button className={`delay-100 transition font-[0.9rem] rounded-lg mt-2 px-4 py-1 border-2 text-md border-gray-500 text-gray-500 lg:w-1/2 m-auto flex items-center justify-center gap-3`}><FcGoogle className="mt-1"/> <span>Register with google</span></button>   
        </form>
      </div>
    );
  };
