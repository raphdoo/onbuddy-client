        ...
        <form className="p-6 flex flex-col justify-center items-center w-full ">
          ...
          <div className="mb-6 w-3/4 m-auto">
            ...
            <div className="relative flex items-center">
                ...
                type="text"
                id="email"
                className="rounded-md border border-gray-300 block w-full px-3 p-2.5 border-none"
          ...
          <div className="mb-6 w-3/4 m-auto">
            ...
            <div className="flex relative items-center">
                ...
                className="rounded-md border border-gray-300 block w-full p-2.5 border-none"
              
                />
            </div>
            <a href="/login" className="text-sm bg-primary text-white rounded-md ml-2 px-2 py-2 w-full mt-4 block text-center">
            Verify
            </a>
          </div>
        </form>
