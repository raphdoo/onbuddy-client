    ...
    return (
      <div className="text-black text-2xl grid md:grid-cols-2 items-center h-screen bg-background">
        ...
        <form className="p-6 grid items-center w-full ">
            ...
            <p className="text-center"><a href="/login" className="text-primary font-semibold">Go to Login</a></p>
          <div className="mb-6 w-3/4 m-auto">
            ...
            <div className="relative flex items-center">
                ...
                required
                />
                <button className="text-sm h-full bg-primary text-white rounded-md ml-2 px-2 w-1/3 py-2">Get code</button>
            </div>
          </div>
          <div className="mb-6 w-3/4 m-auto">
            ...
            <div className="flex relative items-center">
                ...
                required
                />
          <a href="/confirm-password" className="text-center text-sm bg-primary text-white rounded-md ml-2 px-2 py-2 w-1/3 m-auto">Verify</a>
            </div>
          </div>
        </form>
      </div>
